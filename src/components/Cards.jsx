      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 animate__animated animate__bounce">
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-300">
              סחור עם ביטחון באמצעות המערכת של קורבטו. המשלב קשת רחבה של אסטרטגיות מסחר במערכת חלקה. מתוכנן לקלות ויעילות, הוא מאפשר לך לעקוף ניתוח שוק נרחב ואת הטרחה של אחזקת כתבי עת מקצועיים. גלה את העידן החדש של המסחר היום.
            </p>
          </a>
